...
<head>
<meta charset="UTF-8">
<title>ExamHammer Examiner Panel</title>
...
<div class="layout">
  ...
  <div id="sidebar">
    ...
    <a href="${pageContext.request.contextPath}/examiner/exams">
    ...
    <div class="topbar d-flex align-items-center justify-content-between">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <div>
          ...
          <div class="text-muted" style="font-size:13px;">Examiner Panel</div>
        </div>
      </div>
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <a class="dropdown-item" href="${pageContext.request.contextPath}/examiner/profile">
                <i class="bi bi-person me-2"></i>My Profile
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="${pageContext.request.contextPath}/examiner/changePassword">
